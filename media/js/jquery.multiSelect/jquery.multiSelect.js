...
if(jQuery) (function($){
	...
	$.extend($.fn, {
		multiSelect: function(o, callback) {
			...
			if( o.selectAllText == undefined ) o.selectAllText = "Seleccionar todo";
			if( o.noneSelected == undefined ) o.noneSelected = 'Solo mostrar';
			if( o.oneOrMoreSelected == undefined ) o.oneOrMoreSelected = '% seleccionadas';
